...
import { B as ButtonBase } from '../../common/ButtonBase-fa8957d0.js';
...
var Button = /*#__PURE__*/react.forwardRef(function Button(props, ref) {
  ...
  var startIcon = startIconProp && /*#__PURE__*/react.createElement("span", {
    className: __pika_web_default_export_for_treeshaking__$1(classes.startIcon, classes["iconSize".concat(capitalize(size))])
  }, startIconProp);
  var endIcon = endIconProp && /*#__PURE__*/react.createElement("span", {
    className: __pika_web_default_export_for_treeshaking__$1(classes.endIcon, classes["iconSize".concat(capitalize(size))])
  }, endIconProp);
  return /*#__PURE__*/react.createElement(ButtonBase, _extends({
    className: __pika_web_default_export_for_treeshaking__$1(classes.root, classes[variant], className, color === 'inherit' ? classes.colorInherit : color !== 'default' && classes["".concat(variant).concat(capitalize(color))], size !== 'medium' && [classes["".concat(variant, "Size").concat(capitalize(size))], classes["size".concat(capitalize(size))]], disableElevation && classes.disableElevation, disabled && classes.disabled, fullWidth && classes.fullWidth),
    component: component,
    disabled: disabled,
    focusRipple: !disableFocusRipple,
    focusVisibleClassName: __pika_web_default_export_for_treeshaking__$1(classes.focusVisible, focusVisibleClassName),
    ref: ref,
    type: type
