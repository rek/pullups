...
function setInTreeCache(root, route, result) {
  if (root == null) {
    ...
    if (route.length === 0) {
      !(root.type === 'result') ?  Recoil_invariant(false) : void 0;
      ...
      if (root.result && root.result.state === 'loading') {
        ...
        !(root.result === result) ?  Recoil_invariant(false) : void 0;
        const ret = root;
        return ret;
      }
    } else {
      const [path, ...rest] = route;
      const [nodeKey, value] = path;
      !(root.type === 'branch') ?  Recoil_invariant(false) : void 0;
      !(root.nodeKey === nodeKey) ?  Recoil_invariant(false) : void 0;
...
export { Recoil_index_2 as RecoilRoot, Recoil_index_4 as atom, Recoil_index_5 as selector, Recoil_index_13 as useRecoilState };
