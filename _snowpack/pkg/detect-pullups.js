 ...
 * @returns {Number|null}
 */
var _default = function refineSpikes(distance, item, i, array){
...
var core = function SlayerFactory(config){
  return new Slayer(config);
};

var Slayer_1 = Slayer;
core.Slayer = Slayer_1;
...
function fromArray(data){
  ...
  return new Promise(function(resolve) {
    ...
    var spikes = data
      ...
      .map(_common.objectMapper.bind(self, data))
      .filter(_common.cleanEmptyElement.bind(null, self.config.transformedValueProperty));
...
core.Slayer.prototype.fromArray = array;
...
var detectPeaks = /*#__PURE__*/function () {
  var _ref = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(line, otherOptions) {
    var peaks;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return slayer(_extends({
              minPeakDistance: 10
            }, otherOptions)).fromArray(line);
  ...
  return function detectPeaks(_x, _x2) {
...
var detectFlatSections = function detectFlatSections(data, windowSize, allowedDeviation) {
...
var detectDescendingBeforePoint = function detectDescendingBeforePoint(data, position, // the middle of the peak (eg: point 2 from above picture)
_temp) {
...
var logLevel = process.env.LOG || 2;
...
var flatThenSpike = function flatThenSpike(line, _ref) {
  var bodyWeight = _ref.bodyWeight,
      ...
      flatLineAllowedDeviation = _ref.flatLineAllowedDeviation;
  var segments = [];
  var flats = detectFlatSections(line, 5, flatLineAllowedDeviation);
  logDebug("Detected flats:", flats, {
    minLength: minLength
  });
