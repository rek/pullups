...
import { j as __extends$1, a as __awaiter, b as __generator, k as getUA, l as __spreadArrays, m as isMobileCordova, n as isReactNative, o as isElectron, p as isIE, q as isUWP, g as isBrowserExtension, r as LogLevel, L as Logger, C as Component, f as firebase$1 } from '../common/index.esm-671f1674.js';
 ...
 */ function E$1(t) {
    ...
    if (_.logLevel <= LogLevel.DEBUG) {
        var i = n.map(A$1);
        _.debug.apply(_, __spreadArrays([ "Firestore (8.2.2): " + t ], i));
    }
}
...
function T$1(t) {
    ...
    if (_.logLevel <= LogLevel.ERROR) {
        var i = n.map(A$1);
        _.error.apply(_, __spreadArrays([ "Firestore (8.2.2): " + t ], i));
    }
}
...
function N$1(t) {
    ...
    if (_.logLevel <= LogLevel.WARN) {
        var i = n.map(A$1);
        _.warn.apply(_, __spreadArrays([ "Firestore (8.2.2): " + t ], i));
    }
}
...
var V$1 = {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            return new t(R$1.fromBase64String(e));
        } catch (e) {
            throw new U$1(V$1.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
     ...
     */
    t.fromUint8Array = function(e) {
        return new t(R$1.fromUint8Array(e));
    }, 
    /**
...
/** Helper function to assert Uint8Array is available at runtime. */ function j() {
    if ("undefined" == typeof Uint8Array) throw new U$1(V$1.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function F$1() {
    if ("undefined" == typeof atob) throw new U$1(V$1.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}

/** Immutable class holding a blob (binary data) */ var z$1 = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return __extends$1(e, t), e.fromBase64String = function(t) {
        return F$1(), new e(M$1.fromBase64String(t));
    }, e.fromUint8Array = function(t) {
        return j(), new e(M$1.fromUint8Array(t));
    }, e.prototype.toBase64 = function() {
        return F$1(), this._.toBase64();
 ...
 * limitations under the License.
 */
/** A user with a null UID. */ K$1.UNAUTHENTICATED = new K$1(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
K$1.P = new K$1("google-credentials-uid"), K$1.g = new K$1("first-party-uid");
...
var H$1 = function(t, e) {
    ...
    function t(t) {
        ...
        this.currentUser = K$1.UNAUTHENTICATED, this.N = !1, 
        /**
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.O !== e ? (E$1("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (D$1("string" == typeof n.accessToken), new H$1(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.F = function() {
        ...
        return D$1(null === t || "string" == typeof t), new K$1(t);
    }, t;
}(), Q$1 = /** @class */ function() {
    function t(t, e) {
        this.k = t, this.M = e, this.type = "FirstParty", this.user = K$1.g;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Q$1(this.k, this.M));
    }, t.prototype.S = function(t) {
...
/** A CredentialsProvider that always yields an empty token. */ X$1.U = -1;
...
var $ = /** @class */ function() {
     ...
     */
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new U$1(V$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new U$1(V$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new U$1(V$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new U$1(V$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
    ...
    t.prototype.toMillis = function() {
        ...
        return this.seconds === t.seconds ? P$1(this.nanoseconds, t.nanoseconds) : P$1(this.seconds, t.seconds);
    }, 
    /**
    ...
    e.ct = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var u = o[i];
            if (u.indexOf("//") >= 0) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid segment (" + u + "). Paths must not contain // in them.");
    ...
    e._t = function(t) {
        for (var n = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            n.push(r), r = "";
        }, u = !1; i < t.length; ) {
            var s = t[i];
            if ("\\" === s) {
                if (i + 1 === t.length) throw new U$1(V$1.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new U$1(V$1.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === s ? (u = !u, i++) : "." !== s || u ? (r += s, i++) : (o(), i++);
        }
        if (o(), u) throw new U$1(V$1.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new e(n);
    }, e.at = function() {
        return new e([]);
    }, e;
...
/** Converts the possible Proto types for Blobs into a ByteString. */ function lt(t) {
    return "string" == typeof t ? R$1.fromBase64String(t) : R$1.fromUint8Array(t);
}
...
/** Extracts the backend's type order for the provided value. */ function wt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? pt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : S$1();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function bt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return L$1(t.arrayValue.values || [], e.arrayValue.values || [], bt);
...
function It(t, e) {
    var n = wt(t), r = wt(e);
    if (n !== r) return P$1(n, r);
    switch (n) {
      case 0 /* NullValue */ :
        return 0;

      case 1 /* BooleanValue */ :
        return P$1(t.booleanValue, e.booleanValue);
      ...
      case 5 /* StringValue */ :
        return P$1(t.stringValue, e.stringValue);
      ...
      case 7 /* RefValue */ :
        return function(t, e) {
            ...
            return P$1(n.length, r.length);
        }(t.referenceValue, e.referenceValue);

      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = P$1(ht(t.latitude), ht(e.latitude));
            return 0 !== n ? n : P$1(ht(t.longitude), ht(e.longitude));
...
function Et(t, e) {
    if ("string" == typeof t && "string" == typeof e && t.length === e.length) return P$1(t, e);
    var n = ft(t), r = ft(e), i = P$1(n.seconds, r.seconds);
    return 0 !== i ? i : P$1(n.nanos, r.nanos);
}
...
function _e(t, e, n) {
    var r = t.field.ht() ? it.J(e.key, n.key) : function(t, e, n) {
        ...
        return null !== r && null !== i ? It(r, i) : S$1();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 */ var Ie = /** @class */ function() {
     ...
     */ , u) {
        void 0 === i && (i = Z$1.min()), void 0 === o && (o = Z$1.min()), void 0 === u && (u = R$1.h), 
 ...
 */ function Be(t, e, n, r) {
    return t instanceof We ? function(t, e, n, r) {
        ...
        return Fe(t.Gt, e) ? new Ut(t.key, Z$1.min()) : e;
    }(t, e);
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && L$1(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Oe && e instanceof Oe || t instanceof Le && e instanceof Le ? L$1(t.elements, e.elements, bt) : t instanceof Re && e instanceof Re ? bt(t.Qt, e.Qt) : t instanceof ke && e instanceof ke;
 ...
 */ function Je(t) {
    return t instanceof Vt ? t.version : Z$1.min();
}
 ...
 */ function sn(t) {
    ...
    return T$1("GRPC error has no .code"), V$1.UNKNOWN;
    switch (t) {
      case tn.OK:
        return V$1.OK;
...
var an = /** @class */ function() {
    ...
    t.prototype.me = function() {
        if (this._e() && this.left._e()) throw S$1();
        if (this.right._e()) throw S$1();
        var t = this.left.me();
        if (t !== this.right.me()) throw S$1();
 ...
 */ var Tn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Dn.Be(e, n)), new t(Z$1.min(), r, En(), dn(), _n());
    }, t;
}(), Dn = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = R$1.h), void 0 === r && (r = null), this.state = t, this.targetIds = e, 
    ...
    t.prototype.yn = function(t) {
        ...
        if (r) {
            ...
            if (Gt(i)) if (0 === n) {
                ...
                // queries.
                var o = new it(i.path);
                this.Tn(e, o, new Ut(o, Z$1.min()));
            } else D$1(1 === n); else this.Vn(e) !== n && (
    ...
    t.prototype.pn = function(t) {
        ...
        return this._n = dn(), this.fn = Cn(), this.dn = new hn(P$1), i;
    }, 
    /**
    ...
    t.prototype.cn = function(t) {
        ...
        var e = this.fn.get(t);
        return e || (e = new hn(P$1), this.fn = this.fn.Ht(t, e)), e;
    }, 
    /**
...
function Hn(t, e) {
    var n = Bn(e);
    if (n.get(1) !== t.T.projectId) throw new U$1(V$1.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.T.projectId);
    if (n.get(3) !== t.T.database) throw new U$1(V$1.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.T.database);
    return new it(Yn(n));
}
...
function Yn(t) {
    return D$1(t.length > 4 && "documents" === t.get(4)), t.X(5)
...
function tr(t, e) {
    var n = e.currentDocument ? function(t) {
        ...
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) D$1("REQUEST_TIME" === e.setToServerValue), n = new ke; else if ("appendMissingElements" in e) {
                var r = e.appendMissingElements.values || [];
                n = new Oe(r);
            } else if ("removeAllFromArray" in e) {
                var i = e.removeAllFromArray.values || [];
                n = new Le(i);
            } else "increment" in e ? n = new Re(t, e.increment) : S$1();
 ...
 */ var vr = function() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.On && S$1(), this.On = !0, this.Nn ? this.error ? this.Fn(n, this.error) : this.kn(e, this.result) : new t((function(t, i) {
            r.Cn = function(n) {
                r.kn(e, n).next(t, i);
            }, r.xn = function(e) {
                r.Fn(n, e).next(t, i);
    ...
    return t.open = function(e, n, r, i) {
        ...
        t && this.qn.reject(t), this.aborted || (E$1("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    function t(e, r, i) {
        ...
        // log on 12.2.
        12.2 === t.Kn(getUA()) && T$1("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    return t.delete = function(t) {
        return E$1("SimpleDb", "Removing database:", t), Er(window.indexedDB.deleteDatabase(t)).Mn();
    }, 
    /** Returns true if IndexedDB is available in the current environment. */ t.jn = function() {
        ...
        // Check the UA string to find out the browser.
                var e = getUA(), r = t.Kn(e), i = 0 < r && r < 10, o = t.Gn(e), u = 0 < o && o < 4.5;
        // IE 10
                  ...
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, r) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            "VersionError" === n.name ? r(new U$1(V$1.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r(new br(t, n));
                        }, i.onupgradeneeded = function(t) {
                            E$1("SimpleDb", 'Database "' + n.name + '" requires upgrade from version:', t.oldVersion);
                            var e = t.target.result;
                            n.Qn.Yn(e, i.transaction, t.oldVersion, n.version).next((function() {
                                E$1("SimpleDb", "Database upgrade to version " + n.version + " complete");
                            }));
                        };
                    })) ]);
                    ...
                    i = "readonly" === e, o = 0, u = function() {
                        ...
                        return __generator(this, (function(h) {
                            switch (h.label) {
                              ...
                              case 4:
                                return c = h.sent(), f = "FirebaseError" !== c.name && o < 3, E$1("SimpleDb", "Transaction failed with error:", c.message, "Retrying:", f), 
    ...
    function e(e, n) {
        var r = this;
        return (r = t.call(this, V$1.UNAVAILABLE, "IndexedDB transaction '" + e + "' failed: " + n) || this).name = "IndexedDbTransactionError", 
        r;
    }
    return __extends$1(e, t), e;
}(U$1);
 ...
 */ var Ir = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return E$1("SimpleDb", "ADD", this.store.name, t, t), Er(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        return E$1("SimpleDb", "DELETE", this.store.name, t), Er(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return E$1("SimpleDb", "COUNT", this.store.name), Er(this.store.count());
...
function Nr(t) {
    ...
    if (e >= 12.2 && e < 13) {
        ...
        if (t.message.indexOf(r) >= 0) {
            ...
            var i = new U$1("internal", "IOS_INDEXEDDB_BUG1: IndexedDb has thrown '" + r + "'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
            return Tr || (Tr = !0, 
 ...
 */ var Ar = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.As && (this.clearTimeout(), this.Ts.reject(new U$1(V$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
 ...
 */ function Sr(t, e) {
    if (T$1("AsyncQueue", e + ": " + t), _r(t)) return new U$1(V$1.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ function Lr(t) {
    ...
    var e = t.length;
    if (D$1(e >= 2), 2 === e) return D$1("" === t.charAt(0) && "" === t.charAt(1)), et.at();
...
// Visible for testing
var Yr = __spreadArrays(__spreadArrays(__spreadArrays(__spreadArrays([ Vr.store, Ur.store, Mr.store, Fr.store, Gr.store, Rr.store, Kr.store, Br.store ], [ Jr.store ]), [ zr.store ]), [ Hr.store ]), [ Wr.store, Qr.store ]), Xr = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
...
/** Decodes a DbTarget into TargetData */ function ci(t) {
    var e, n, r = si(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? si(t.lastLimboFreeSnapshotVersion) : Z$1.min();
    return void 0 !== t.query.documents ? (D$1(1 === (n = t.query).documents.length), 
    e = de(se(Wn(n.documents[0])))) : e = function(t) {
        return de(rr(t));
    }(t.query), new Ie(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, R$1.fromBase64String(t.resumeToken))
...
function _i(t) {
    return __awaiter(this, void 0, void 0, (function() {
        return __generator(this, (function(e) {
            if (t.code !== V$1.FAILED_PRECONDITION || t.message !== Dr) throw t;
...
/** A mutation queue for a specific user, backed by IndexedDB. */ var Ai = /** @class */ function() {
    ...
    return t.Ai = function(e, n, r, i) {
        ...
        return D$1("" !== e.uid), new t(e.A() ? e.uid : "", n, r, i);
        ...
        var n = this;
        return Di(t).get(e).next((function(t) {
            return t ? (D$1(t.userId === n.userId), ai(n.Kt, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.gi = function(t, e) {
        ...
        return Di(t).ls({
            ...
            e.userId === n.userId && (D$1(e.batchId >= r), o = ai(n.Kt, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        // the given documentKey.
            ...
            return Di(t).get(c).next((function(t) {
                if (!t) throw S$1();
                D$1(t.userId === n.userId), o.push(ai(n.Kt, t));
            }));
            u.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = e.path, i = r.length + 1, o = Mr.prefixForPath(this.userId, r), u = IDBKeyRange.lowerBound(o), s = new hn(P$1);
        return xi(t).ls({
            range: u
        }, (function(t, e, o) {
        ...
        return e.forEach((function(e) {
            i.push(Di(t).get(e).next((function(t) {
                if (null === t) throw S$1();
                D$1(t.userId === n.userId), r.push(ai(n.Kt, t));
            })));
        })), yr.$n(i).next((function() {
            return r;
        }));
 ...
 */ var Oi = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Ui(t).next((function(t) {
            return Z$1.j(new $(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        return this.Xi(t, e.targetId).next((function() {
            ...
            return D$1(e.targetCount > 0), e.targetCount -= 1, n.Qi(t, e);
        }));
    }, 
    /**
 ...
 * limitations under the License.
 */ function Vi(t, e) {
    var n = t[0], r = t[1], i = e[0], o = e[1], u = P$1(n, i);
    return 0 === u ? P$1(r, o) : u;
}
 ...
 */ var Ui = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        ...
        E$1("LruGarbageCollector", "Garbage collection scheduled in " + n + "ms"), this.wr = this.fs.Ir("lru_garbage_collection" /* LruGarbageCollection */ , n, (function() {
            return __awaiter(e, void 0, void 0, (function() {
                ...
                return __generator(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return _r(e = n.sent()) ? (E$1("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.Rr = function(t, e) {
        ...
        var n = this;
        if (0 === e) return yr.resolve(X$1.U);
        var r = new Ui(e);
        ...
        var n = this;
        return -1 === this.params.Hs ? (E$1("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        yr.resolve(wi)) : this.br(t).next((function(r) {
            return r < n.params.Hs ? (E$1("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.params.Hs), 
            wi) : n.vr(t, e);
        }));
        ...
        return this.Rr(t, this.params.Js).next((function(e) {
            ...
            return e > f.params.Ys ? (E$1("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + f.params.Ys + " from " + e), 
 ...
 */ var zi = /** @class */ function() {
    ...
    t.prototype.$r = function(t) {
        if (t) {
            var e = ni(this.Kt, t);
            return e instanceof Ut && e.version.isEqual(Z$1.min()) ? null : e;
        }
        return null;
    }, t;
}(), Gi = /** @class */ function(t) {
    ...
    return __extends$1(e, t), e.prototype.Ei = function(t) {
        ...
        return this.oi.forEach((function(o, u) {
            ...
            if (u.li) {
                ...
                var f = ri(e.Gr.Kt, new Ut(o, Z$1.min()), e.ai(o));
...
/** Performs database creation and schema upgrades. */ var Ji = /** @class */ function() {
     ...
     */
            return function(t) {
                ...
                /*highestTargetId=*/ 0, 
                /*lastListenSequenceNumber=*/ 0, Z$1.min().G(), 
                /*targetCount=*/ 0);
...
var Qi = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Yi = /** @class */ function() {
    ...
    f) {
        ...
        }, !t.jn()) throw new U$1(V$1.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        ...
        !1 === f && T$1("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
    }
    /**
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new U$1(V$1.FAILED_PRECONDITION, Qi);
    ...
    t.prototype.Qo = function() {
        ...
        return this._o.runTransaction(t, o, Yr, (function(o) {
            return i = new Xr(o, r.io ? r.io.next() : X$1.U), "readwrite-primary" === e ? r.po(i).next((function(t) {
                return !!t || r.vo(i);
            })).next((function(e) {
                if (!e) throw T$1("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.eo.bo((function() {
                    return r.ho(!1);
                })), new U$1(V$1.FAILED_PRECONDITION, Dr);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.Go = function(t) {
        var e = this;
        return Xi(t).get(Rr.key).next((function(t) {
            if (null !== t && e.Oo(t.leaseTimestampMs, 5e3) && !e.Mo(t.ownerId) && !e.Co(t) && !(e.so || e.allowTabSynchronization && t.allowTabSynchronization)) throw new U$1(V$1.FAILED_PRECONDITION, Qi);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.So = function(t) {
        ...
        return n.get(Rr.key).next((function(t) {
            return e.Co(t) ? (E$1("IndexedDbPersistence", "Releasing primary lease."), n.delete(Rr.key)) : yr.resolve();
        }));
    }, 
    ...
    t.prototype.tc = function(t, e) {
        ...
        return this.Ho.Si(t, e).next((function(r) {
            ...
            return i.forEach((function(t, e) {
                ...
                e || (e = new Ut(t, Z$1.min())), o = o.Ht(t, e);
            })), o;
        }));
    }, 
    /**
 ...
 */
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.jr = function(t, n, r, i) {
        ...
        }(n) || r.isEqual(Z$1.min()) ? this.hc(t, n) : this.uc.Zo(t, i).next((function(u) {
            var s = o.lc(n, u);
            return (ae(n) || ce(n)) && o._c(n.limitType, s, i, r) ? o.hc(t, n) : (I$1() <= LogLevel.DEBUG && E$1("QueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), ge(n)), 
    ...
    t.prototype._c = function(t, e, n, r) {
        ...
        return I$1() <= LogLevel.DEBUG && E$1("QueryEngine", "Using full collection scan to execute query:", ge(n)), 
        this.uc.jr(t, n, Z$1.min());
    }, t;
}(), io = /** @class */ function() {
    function t(
    ...
    t, e, n, r) {
        ...
        /**
             ...
             */
        this.Ec = Z$1.min(), this.Ho = t.Ko(n), this.Tc = t.Fr(), this.fo = t.Dr(), this.Ic = new eo(this.Tc, this.Ho, this.persistence.jo()), 
...
function uo(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(u) {
            switch (u.label) {
              case 0:
                return n = x$1(t), r = n.Ho, i = n.Ic, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
        ...
        return function(t, e, n, r) {
            ...
            return o.forEach((function(t) {
                u = u.next((function() {
                    ...
                    D$1(null !== u), (!o || o.version.u(u) < 0) && ((o = i.Ds(t, o, n)) && 
 ...
 */ function co(t, e) {
     ...
     */
                    function(t, e, n) {
                        ...
                        return D$1(e.resumeToken.o() > 0), 0 === t.resumeToken.o() || (
...
i) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, u) {
            ...
            // cache.
                        u instanceof Ut && u.version.isEqual(Z$1.min()) ? (
            ...
            o = o.Ht(n, u)) : E$1("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", s.version, " Watch version:", u.version);
        })), o;
    }))
    /**
...
function po(t, e, n) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(s) {
            switch (s.label) {
              case 0:
                r = x$1(t), i = r.dc.get(e), o = n ? "readwrite" : "readwrite-primary", s.label = 1;
              ...
              case 4:
                ...
                // don't define exact LRU semantics so this is acceptable.
                                return E$1("LocalStore", "Failed to update sequence numbers for target " + e + ": " + u), 
                [ 3 /*break*/ , 5 ];
 ...
 */ function vo(t, e, n) {
    var r = x$1(t), i = Z$1.min(), o = _n();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = x$1(t), i = r.wc.get(n);
            ...
            return r.fc.jr(t, e, n ? i : Z$1.min(), n ? o : _n());
        })).next((function(t) {
            return {
                documents: t,
                Pc: o
...
// PORTING NOTE: Multi-Tab only.
function yo(t, e) {
    var n = x$1(t), r = x$1(n.fo), i = n.dc.get(e);
...
function mo(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = x$1(t), i = dn(), o = ii(n), u = Ki(e), s = IDBKeyRange.lowerBound(o, !0);
            return u.ls({
...
function go(t) {
    return __awaiter(this, void 0, void 0, (function() {
        var e;
        return __generator(this, (function(n) {
            return [ 2 /*return*/ , (e = x$1(t)).persistence.runTransaction("Synchronize last document change read time", "readonly", (function(t) {
                return function(t) {
                    var e = Ki(t), n = Z$1.min();
 ...
 */ var _o = /** @class */ function() {
    ...
    return t.Dc = function(t, e) {
        return it.J(t.key, e.key) || P$1(t.$c, e.$c);
    }, 
    /** Compare by ID then by key */ t.xc = function(t, e) {
        return P$1(t.$c, e.$c) || it.J(t.key, e.key);
    }, t;
}(), To = /** @class */ function() {
    function t(t, e) {
        this.Ti = t, this.Ii = e, 
    ...
    return t.prototype.Ri = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                it.Et(i) || (i = i.child(""));
        var o = new Eo(new it(i), 0), u = new hn(P$1);
        ...
        var n = this;
        D$1(0 === this.jc(e.batchId, "removed")), this.Ho.shift();
        var r = this.qc;
    ...
    function t(t, e) {
        var n = this;
        this.Xc = {}, this.io = new X$1(0), this.ro = !1, this.ro = !0, this.Ii = t(this), 
...
var Co = /** @class */ function() {
    ...
    return t.aa = function(e, n, r) {
        ...
        return o && i.error && ((o = "string" == typeof i.error.message && "string" == typeof i.error.code) && (u = new U$1(i.error.code, i.error.message))), 
        o ? new t(e, n, i.state, u) : (T$1("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), 
        null);
    ...
    return t.aa = function(e, n) {
        ...
        return i && r.error && ((i = "string" == typeof r.error.message && "string" == typeof r.error.code) && (o = new U$1(r.error.code, r.error.message))), 
    ...
    function t(t, e, n, r, i) {
        ...
        this.da = null, this.L = null, this.wa = this.Ea.bind(this), this.Ta = new an(P$1), 
        this.Tr = !1, 
        /**
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.jn = function(t) {
        ...
        // `Window.addEventListener`.
            ...
            if (E$1("SharedClientState", "EVENT", n.key, n.newValue), n.key === this.ma) return void T$1("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.eo.bo((function() {
                return __awaiter(e, void 0, void 0, (function() {
                    var t, e, r, i, o, u;
                    return __generator(this, (function(s) {
                        if (this.Tr) {
                            if (null !== n.key) if (this.Ra.test(n.key)) {
                                ...
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                    D$1("number" == typeof n), e = n;
                                } catch (t) {
                                    T$1("SharedClientState", "Failed to read sequence number from WebStorage", t);
                                }
                                return e;
                            }(n.newValue)) !== X$1.U && this.L(u); else if (n.key === this.Va) return [ 2 /*return*/ , this.fa.eu() ];
                        } else this.Ia.push(n);
                        return [ 2 /*return*/ ];
                    }));
                }));
    ...
    t.prototype.ba = function(t) {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.fa.nu(t.batchId, t.state, t.error) ] : (E$1("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    ...
    return __extends$1(e, t), e.prototype.Du = function(t, e, n, r) {
                ...
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case ErrorCode.TIMEOUT:
                        E$1("Connection", 'RPC "' + t + '" timed out'), o(new U$1(V$1.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case ErrorCode.HTTP_ERROR:
                        var n = u.getStatus();
                        if (E$1("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", u.getResponseText()), 
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new U$1(s, r.message));
                            } else o(new U$1(V$1.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new U$1(V$1.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.Vu, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], c = createWebChannelTransport(), f = getStatEventTarget(), h = {
        ...
        isMobileCordova() || isReactNative() || isElectron() || isIE() || isUWP() || isBrowserExtension() || (h.httpHeadersOverwriteParam = "$httpHeaders");
        var m = n.join("");
        E$1("Connection", "Creating WebChannel: " + m, h);
        var g = c.createWebChannel(m, h), w = !1, b = !1, _ = new Bo({
            du: function(t) {
                b ? E$1("Connection", "Not sending because WebChannel is closed:", t) : (w || (E$1("Connection", "Opening WebChannel transport."), 
                g.open(), w = !0), E$1("Connection", "WebChannel sending:", t), g.send(t));
            },
            wu: function() {
                return g.close();
            }
        ...
        return I(g, WebChannel.EventType.OPEN, (function() {
            b || E$1("Connection", "WebChannel transport opened.");
        })), I(g, WebChannel.EventType.CLOSE, (function() {
            b || (b = !0, E$1("Connection", "WebChannel transport closed"), _.Pu());
        })), I(g, WebChannel.EventType.ERROR, (function(t) {
            b || (b = !0, N$1("Connection", "WebChannel transport errored:", t), _.Pu(new U$1(V$1.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    void 0 === u && (u = V$1.INTERNAL, s = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    b = !0, _.Pu(new U$1(u, s)), g.close();
                } else E$1("Connection", "WebChannel received:", n), _.yu(n);
            }
        })), I(f, Event.STAT_EVENT, (function(t) {
            t.stat === Stat.PROXY ? E$1("Connection", "Detected buffering proxy") : t.stat === Stat.NOPROXY && E$1("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
 ...
 */ var Qo = /** @class */ function() {
    ...
    t.prototype.Bu = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && E$1("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.ku + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.zu.reset() : e && e.code === V$1.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    T$1(e.toString()), T$1("Using maximum backoff delay to prevent overloading the backend."), 
                    this.zu.$u()) : e && e.code === V$1.UNAUTHENTICATED && 
    ...
    t.prototype.sh = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new U$1(V$1.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.oh(e);
            }));
        }));
    ...
    t.prototype.ih = function(t) {
        ...
        return function(n) {
            e.eo.ys((function() {
                return e.Wu === t ? n() : (E$1("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.qt ? (D$1(void 0 === e || "string" == typeof e), R$1.fromBase64String(e || "")) : (D$1(void 0 === e || e instanceof Uint8Array), 
                    R$1.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), u = (s = e.targetChange.cause) && function(t) {
                    var e = void 0 === t.code ? V$1.UNKNOWN : sn(t.code);
                    return new U$1(e, t.message || "");
                }(s);
            ...
            i = Hn(t, r.document), o = r.readTime ? zn(r.readTime) : Z$1.min(), s = new Ut(i, o), 
            ...
            return e.targetIds && e.targetIds.length ? Z$1.min() : e.readTime ? zn(e.readTime) : Z$1.min();
        }(t);
    ...
    e.prototype.hh = function(t) {
        ...
        e.database = Qn(this.Kt), e.addTarget = function(t, e) {
            ...
            return (n = Gt(r) ? {
                ...
                query: nr(t, r)
            }).targetId = e.targetId, e.resumeToken.o() > 0 ? n.resumeToken = jn(t, e.resumeToken) : e.Mt.u(Z$1.min()) > 0 && (
    ...
    e.prototype.start = function() {
        ...
        D$1(!!t.streamToken), this.lastStreamToken = t.streamToken, this._h) {
        ...
        // The first response is always the handshake response
                return D$1(!t.writeResults || 0 === t.writeResults.length), this._h = !0, 
        this.listener.Eh();
    }, 
    /**
    ...
    return __extends$1(e, t), e.prototype.mh = function() {
        if (this.Ih) throw new U$1(V$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ e.prototype.bu = function(t, e, n) {
        ...
        return this.mh(), this.credentials.getToken().then((function(i) {
            ...
            throw t.code === V$1.UNAUTHENTICATED && r.credentials.v(), t;
        }));
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.Ph ? (T$1(e), this.Ph = !1) : E$1("OnlineStateTracker", e);
        ...
        n.ys((function() {
            return __awaiter(o, void 0, void 0, (function() {
                return __generator(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return fu(this) ? (E$1("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return __awaiter(this, void 0, void 0, (function() {
                                var e;
                                return __generator(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = x$1(t)).Oh.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , ru(e) ];
    ...
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(u) {
            switch (u.label) {
              ...
              case 3:
                return r = u.sent(), E$1("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), r), 
                [ 4 /*yield*/ , vu(t, r) ];
              ...
              case 6:
                if (e instanceof xn ? t.Lh.wn(e) : e instanceof kn ? t.Lh.yn(e) : t.Lh.In(e), n.isEqual(Z$1.min())) return [ 3 /*break*/ , 13 ];
                u.label = 7;
              ...
              case 11:
                return E$1("RemoteStore", "Failed to raise snapshot:", o = u.sent()), [ 4 /*yield*/ , vu(t, o) ];
                ...
                t.fs.bo((function() {
                    return __awaiter(r, void 0, void 0, (function() {
                        return __generator(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return E$1("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , n() ];
...
function mu(t) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(u) {
            switch (u.label) {
              case 0:
                e = x$1(t), n = Au(e), r = e.xh.length > 0 ? e.xh[e.xh.length - 1].batchId : -1, u.label = 1;
                ...
                return e && Au(t).fh ? [ 4 /*yield*/ , function(t, e) {
                    return __awaiter(this, void 0, void 0, (function() {
                        ...
                        return __generator(this, (function(i) {
                            switch (i.label) {
                              case 0:
                                return un(r = e.code) && r !== V$1.ABORTED ? (n = t.xh.shift(), 
 ...
 */ function Tu(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(i) {
            switch (i.label) {
              case 0:
                return n = x$1(t), e ? (n.Oh.delete(2 /* IsSecondary */), [ 4 /*yield*/ , nu(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return i.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (e) ? [ 3 /*break*/ , 4 ] : (n.Oh.add(2 /* IsSecondary */), [ 4 /*yield*/ , ru(n) ]);

              case 3:
                i.sent(), n.Mh.set("Unknown" /* Unknown */), i.label = 4;
        ...
        return __awaiter(e, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 3:
                    e.sent(), t.xh.length > 0 && (E$1("RemoteStore", "Stopping write stream with " + t.xh.length + " pending writes"), 
                    t.xh = []), e.label = 4;
...
function xu(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(c) {
            switch (c.label) {
              case 0:
                if (n = x$1(t), r = e.query, i = !1, (o = n.queries.get(r)) || (i = !0, o = new Su), 
                !i) return [ 3 /*break*/ , 4 ];
                c.label = 1;
...
function ku(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        var n, r, i, o, u;
        return __generator(this, (function(s) {
            return n = x$1(t), r = e.query, i = !1, (o = n.queries.get(r)) && (u = o.listeners.indexOf(e)) >= 0 && (o.listeners.splice(u, 1), 
...
function Ou(t, e) {
    for (var n = x$1(t), r = !1, i = 0, o = e; i < o.length; i++) {
...
/** Stops listening to the query. */ function Ju(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(o) {
            switch (o.label) {
              case 0:
                return n = x$1(t), r = n.Sl.get(e), (i = n.Dl.get(r.targetId)).length > 1 ? [ 2 /*return*/ , (n.Dl.set(r.targetId, i.filter((function(t) {
                    return !ye(t, e);
            ...
            switch (s.label) {
              ...
              case 1:
                return s.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = x$1(t), i = $.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), _n());
              ...
              case 2:
                return i = s.sent(), r.pl.xa(i.batchId), function(t, e, n) {
                    ...
                    r || (r = new an(P$1)), r = r.Ht(e, n), t.Fl[t.currentUser.R()] = r;
            ...
            switch (i.label) {
              ...
              case 2:
                ...
                e.Fe.forEach((function(t, e) {
                    ...
                    D$1(t.Ue.size + t.Qe.size + t.Ke.size <= 1), t.Ue.size > 0 ? r.yl = !0 : t.Qe.size > 0 ? D$1(r.yl) : t.Ke.size > 0 && (D$1(r.yl), 
                    r.yl = !1));
                })), [ 4 /*yield*/ , as(n, r, e) ];
    ...
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(c) {
            switch (c.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (r = x$1(t)).pl.qa(e, "rejected", n), i = r.Nl.get(e), (o = i && i.key) ? (u = (u = new an(it.J)).Ht(o, new Ut(o, Z$1.min())), 
                s = _n().add(o), a = new Sn(Z$1.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new hn(P$1), u, s), [ 4 /*yield*/ , Qu(r, a) ]) : [ 3 /*break*/ , 2 ];
...
function $u(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(o) {
            switch (o.label) {
              case 0:
                n = x$1(t), r = e.batch.batchId, o.label = 1;
                ...
                return o.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n.Ho.yi(t, e).next((function(e) {
                            return D$1(null !== e), r = e.keys(), n.Ho.xi(t, e);
                        })).next((function() {
                            return n.Ho.Fi(t);
                        })).next((function() {
                            return n.Ic.Zo(t, r);
 ...
 */ function ts(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(s) {
            switch (s.label) {
              case 0:
                fu((n = x$1(t)).gl) || E$1("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                s.label = 1;
...
function ns(t, e, n) {
    var r = x$1(t), i = r.Fl[r.currentUser.R()];
...
function os(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof qu ? (t.Ol.sr(o.key, e), us(t, o)) : o instanceof ju ? (E$1("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function us(t, e) {
    var n = e.key;
    t.xl.get(n) || (E$1("SyncEngine", "New document in limbo: " + n), t.Cl.push(n), ss(t));
}
 ...
 */ function ss(t) {
    for (;t.Cl.length > 0 && t.xl.size < t.bl; ) {
        ...
        t.Nl.set(n, new Gu(e)), t.xl = t.xl.Ht(e, n), iu(t.gl, new Ie(de(se(e.path)), n, 2 /* LimboResolution */ , X$1.U));
    }
}
...
function as(t, e, n) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(s) {
            switch (s.label) {
              case 0:
                return r = x$1(t), i = [], o = [], u = [], r.Sl.nt() ? [ 3 /*break*/ , 3 ] : (r.Sl.forEach((function(t, s) {
                            ...
                            switch (h.label) {
                              ...
                              case 3:
                                ...
                                // would have, but it should not invalidate the integrity of the data.
                                                                return E$1("LocalStore", "Failed to update sequence numbers: " + r), 
                                [ 3 /*break*/ , 4 ];
...
function cs(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(i) {
            switch (i.label) {
              case 0:
                return (n = x$1(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (E$1("SyncEngine", "User change. New user:", e.R()), 
                [ 4 /*yield*/ , uo(n.Sh, e) ]);
              ...
              case 1:
                ...
                function(t, e) {
                    t.kl.forEach((function(t) {
                        t.forEach((function(t) {
                            t.reject(new U$1(V$1.CANCELLED, "'waitForPendingWrites' promise is rejected due to a user change."));
                        }));
                    })), t.kl.clear();
                }(n), 
 ...
 */ function hs(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(o) {
            switch (o.label) {
              case 0:
                return [ 4 /*yield*/ , vo((n = x$1(t)).Sh, e.query, 
                /* usePreviousResults= */ !0) ];
...
function ls(t) {
    return __awaiter(this, void 0, void 0, (function() {
        var e;
        return __generator(this, (function(n) {
            return [ 2 /*return*/ , mo((e = x$1(t)).Sh).then((function(t) {
                return as(e, t);
            })) ];
        }));
    }));
        ...
        return __generator(this, (function(u) {
            switch (u.label) {
              ...
              case 6:
                ...
                // as applicable.
                E$1("SyncEngine", "Cannot apply mutation batch with id: " + e), u.label = 7;
...
function ds(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(f) {
            switch (f.label) {
              case 0:
                return bs(n = x$1(t)), _s(n), !0 !== e || !0 === n.Ll ? [ 3 /*break*/ , 3 ] : (r = n.pl.Sa(), 
                [ 4 /*yield*/ , vs(n, r.rt()) ]);
...
function ms(t) {
    var e = x$1(t);
    return x$1(x$1(e.Sh).persistence).Qo();
}
        ...
        return __generator(this, (function(p) {
            switch (p.label) {
              ...
              case 1:
                ...
                E$1("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , yo(r.Sh, u) ]) : [ 3 /*break*/ , 6 ];
...
var Es = /** @class */ function() {
    ...
    return __extends$1(e, t), e.prototype.initialize = function(e) {
        ...
        var e = Ho();
        if (!qo.jn(e)) throw new U$1(V$1.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        ...
        return function(t) {
            return __awaiter(this, void 0, void 0, (function() {
                ...
                return __generator(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = x$1(t), E$1("RemoteStore", "RemoteStore shutting down."), e.Oh.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , ru(e) ];
 ...
 */ var Ds = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.d_ = new rt(t);
    }
    /**
 ...
 */
function Ps(t, e, n) {
    if (!n) throw new U$1(V$1.INVALID_ARGUMENT, "Function " + t + "() cannot be called with an empty " + e + ".");
}
...
function Ls(t, e) {
    ...
    if (void 0 !== e.mergeFields && void 0 !== e.merge) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
 ...
 */ function Cs(t, e, n, r) {
    if (!0 === e && !0 === r) throw new U$1(V$1.INVALID_ARGUMENT, t + " and " + n + " cannot be used together.");
}
 ...
 */ function Rs(t) {
    if (!it.Et(t)) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function Vs(t) {
    if (it.Et(t)) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
...
e) {
    ...
    t = t._), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new U$1(V$1.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = Us(t);
        throw new U$1(V$1.INVALID_ARGUMENT, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function qs(t, e) {
    if (e <= 0) throw new U$1(V$1.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */ var js = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new U$1(V$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new U$1(V$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    ...
    function t(t, e) {
        ...
        this.m_ = new J$1) : (this.A_ = t, this.I_ = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new U$1(V$1.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
    ...
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this.A_) throw new U$1(V$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.A_;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this.T_) throw new U$1(V$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this.E_ = new js(t), void 0 !== t.credentials && (this.m_ = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new U$1(V$1.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */
        return t = this, (e = Fs.get(t)) && (E$1("ComponentProvider", "Removing Datastore"), 
 ...
 */ function Hs(t, e) {
    ...
    if (t instanceof q$1 && (t = t._), Ps("collection", "path", e), t instanceof zs) return Vs(n = et.ct.apply(et, __spreadArrays([ e ], r))), 
    new Ks(t, /* converter= */ null, n);
    if (!(t instanceof Gs || t instanceof Ks)) throw new U$1(V$1.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Vs(n = et.ct.apply(et, __spreadArrays([ t.path ], r)).child(et.ct(e))), new Ks(t.firestore, 
    /* converter= */ null, n);
}
 ...
 */ function Js(t, e) {
    for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
    if (t instanceof q$1 && (t = t._), 
    // We allow omission of 'pathString' but explicitly prohibit passing in both
    // 'undefined' and 'null'.
    1 === arguments.length && (e = O$1.t()), Ps("doc", "path", e), t instanceof zs) return Rs(n = et.ct.apply(et, __spreadArrays([ e ], r))), 
    new Gs(t, 
    /* converter= */ null, new it(n));
    if (!(t instanceof Gs || t instanceof Ks)) throw new U$1(V$1.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Rs(n = t.D_.child(et.ct.apply(et, __spreadArrays([ e ], r)))), new Gs(t.firestore, t instanceof Ks ? t.v_ : null, new it(n));
}
 ...
 * Firestore database.
 */ function Ws(t, e) {
    return t instanceof q$1 && (t = t._), e instanceof q$1 && (e = e._), (t instanceof Gs || t instanceof Ks) && (e instanceof Gs || e instanceof Ks) && t.firestore === e.firestore && t.path === e.path && t.v_ === e.v_
    /**
...
function Qs(t, e) {
    return t instanceof q$1 && (t = t._), e instanceof q$1 && (e = e._), t instanceof Bs && e instanceof Bs && t.firestore === e.firestore && ye(t.C_, e.C_) && t.v_ === e.v_
    /**
 * @license
 * Copyright 2017 Google LLC
 *
...
var Ys = /** @class */ function() {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new U$1(V$1.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new U$1(V$1.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.x_ = t, this.N_ = e;
    }
     ...
     */
    t.prototype.K = function(t) {
        return P$1(this.x_, t.x_) || P$1(this.N_, t.N_);
    }, t;
...
/** A "context" object passed around while parsing user data. */ var ea$1 = /** @class */ function() {
    /**
    ...
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (ta$1(this.k_) && Xs.test(t)) throw this.K_('Document fields cannot begin and end with "__"');
    }, t;
}(), na$1 = /** @class */ function() {
    function t(t, e, n) {
 ...
 */ function ra$1(t) {
    ...
    return new na$1(t.I_, !!e.ignoreUndefinedProperties, n);
}
...
/** Parse document data from a set() call. */ function ia(t, e, n, r, i, o) {
    ...
    if (o.merge) s = new at(u.zt), a = u.fieldTransforms; else if (o.mergeFields) {
        for (var f = [], h = 0, l = o.mergeFields; h < l.length; h++) {
            var p = ga(e, l[h], n);
            if (!u.contains(p)) throw new U$1(V$1.INVALID_ARGUMENT, "Field '" + p + "' is specified in your field mask but missing from your input data.");
            Ia$1(f, p) || f.push(p);
        }
...
/** Parse update data from an update() call. */ function ha$1(t, e, n, r) {
    ...
    ut(r, (function(t, r) {
        ...
        // performing validation.
                r instanceof q$1 && (r = r._);
        var a = i.U_(s);
        if (r instanceof oa$1) 
...
/** Parse update data from a list of field/value arguments. */ function la(t, e, n, r, i, o) {
    ...
    if (o.length % 2 != 0) throw new U$1(V$1.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) s.push(ga(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var f = [], h = new Lt, l = s.length - 1; l >= 0; --l) if (!Ia$1(f, s[l])) {
        var p = s[l], d = a[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        d instanceof q$1 && (d = d._);
        var v = u.U_(p);
        if (d instanceof oa$1) 
        // Add it to the field mask, but don't add anything to updateData.
        f.push(p); else {
            var y = da$1(d, v);
 ...
 */ function pa$1(t, e, n, r) {
    return void 0 === r && (r = !1), da$1(n, t.G_(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function da$1(t, e) {
    ...
    // from firestore-exp.
    t instanceof q$1 && (t = t._), ya(t)) return ma$1("Unsupported field value:", e, t), 
    va$1(t, e);
    if (t instanceof Os) 
    ...
    return function(t, e) {
        ...
        if (!ta$1(e.k_)) throw e.K_(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        if (t instanceof q$1 && (t = t._), null === t) return {
            nullValue: "NULL_VALUE"
        };
...
function ya(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof $ || t instanceof Ys || t instanceof M$1 || t instanceof Gs || t instanceof Os);
}
 ...
 */ function ga(t, e, n) {
    ...
    // FieldPath.
    e instanceof q$1 && (e = e._), e instanceof ks) return e.d_;
    if ("string" == typeof e) return ba$1(t, e);
 ...
 * evaluated.
 */ function ba$1(t, e, n) {
    if (e.search(wa$1) >= 0) throw _a("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
...
function _a(t, e, n, r, i) {
    ...
    a += ")"), new U$1(V$1.INVALID_ARGUMENT, (s += ". ") + t + a)
 ...
 */ var Ea$1 = /** @class */ function() {
    ...
    return t.prototype.ef = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(r) {
                switch (r.label) {
                  case 0:
                    if (this.nf(), this.mutations.length > 0) throw new U$1(V$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, e) {
                        return __awaiter(this, void 0, void 0, (function() {
                            var n, r, i, o, u, s;
                            return __generator(this, (function(a) {
                                switch (a.label) {
                                  case 0:
                                    return n = x$1(t), r = Qn(n.Kt) + "/documents", i = {
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((e = r.sent()).forEach((function(t) {
                        t instanceof Ut || t instanceof Vt ? n.sf(t) : S$1();
                    })), e) ];
                }
            }));
        }));
        ...
        if (n) {
            ...
            throw new U$1(V$1.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.rf = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new U$1(V$1.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    return t.prototype.run = function() {
        ...
        this.zu.Bu((function() {
            return __awaiter(t, void 0, void 0, (function() {
                var t, e, n = this;
                return __generator(this, (function(r) {
                    return t = new Ea$1(this.Dh), (e = this.uf(t)) && e.then((function(e) {
                        n.fs.ys((function() {
    ...
    e, n) {
        var r = this;
        this.credentials = t, this.fs = e, this.gu = n, this.user = K$1.UNAUTHENTICATED, this.clientId = O$1.t(), 
        this._f = function() {}, this.N = new vr, this.credentials.S((function(t) {
            E$1("FirestoreClient", "Received user=", t.uid), r.user = t, r._f(t), r.N.resolve();
        }));
    }
    ...
    t.prototype.df = function() {
        if (this.fs.wf) throw new U$1(V$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.terminate = function() {
        var t = this;
        this.fs.Ef();
        var e = new vr;
 ...
 */ function Aa$1(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(o) {
            switch (o.label) {
              case 0:
                return t.fs.Af(), E$1("FirestoreClient", "Initializing OfflineComponentProvider"), 
...
function Sa$1(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(i) {
            switch (i.label) {
              case 0:
                return t.fs.Af(), [ 4 /*yield*/ , Da$1(t) ];

              case 1:
                return n = i.sent(), E$1("FirestoreClient", "Initializing OnlineComponentProvider"), 
                [ 4 /*yield*/ , t.getConfiguration() ];
                        ...
                        return function(t, e) {
                            return __awaiter(this, void 0, void 0, (function() {
                                ...
                                return __generator(this, (function(i) {
                                    switch (i.label) {
                                      case 0:
                                        return (n = x$1(t)).fs.Af(), E$1("RemoteStore", "RemoteStore received new credentials"), 
                                        r = fu(n), 
...
function Da$1(t) {
    return __awaiter(this, void 0, void 0, (function() {
        return __generator(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.mf ? [ 3 /*break*/ , 2 ] : (E$1("FirestoreClient", "Using default OfflineComponentProvider"), 
                [ 4 /*yield*/ , Aa$1(t, new Es) ]);
...
function xa(t) {
    return __awaiter(this, void 0, void 0, (function() {
        return __generator(this, (function(e) {
            switch (e.label) {
              case 0:
                return t.If ? [ 3 /*break*/ , 2 ] : (E$1("FirestoreClient", "Using default OnlineComponentProvider"), 
                [ 4 /*yield*/ , Sa$1(t, new As) ]);
...
/** Enables the network connection and re-enqueues all pending operations. */ function Ra$1(t, e, n) {
    var r = this;
    void 0 === n && (n = {});
    var i = new vr;
                    ...
                    return r = function(t, e, n, r, i) {
                        var o = new Ds({
                            next: function(o) {
                                ...
                                i.reject(new U$1(V$1.UNAVAILABLE, "Failed to get document because the client is offline.")) : s && o.fromCache && r && "server" === r.source ? i.reject(new U$1(V$1.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(o);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
                    ...
                    return r = function(t, e, n, r, i) {
                        var o = new Ds({
                            next: function(n) {
                                ...
                                e.ys((function() {
                                    return ku(t, u);
                                })), n.fromCache && "server" === r.source ? i.reject(new U$1(V$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
...
var Ua$1 = /** @class */ function() {
    function t() {
        ...
        this.vf = function() {
            var e = Jo();
            e && E$1("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.zu.Uu();
        };
        var e = Jo();
    ...
    t.prototype.Cf = function() {
        ...
        var e = this, n = this.Rf.then((function() {
            return e.pf = !0, t().catch((function(t) {
                ...
                throw e.Vf = t, e.pf = !1, T$1("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
...
}(), Ma$1 = -1, qa$1 = /** @class */ function(t) {
    /** @hideconstructor */
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, n) || this).Mf = new Ua$1, r.w_ = "name" in e ? e.name : "[DEFAULT]", 
        r;
    }
    return __extends$1(e, t), e.prototype.b_ = function() {
        ...
        Fa$1(this), this.Lf.terminate();
    }, e;
}(zs);

function ja$1(t) {
    return t.Lf || Fa$1(t), t.Lf.df(), t.Lf;
}

function Fa$1(t) {
    var e = t.p_(), n = function(t, e, n) {
        return new G$1(t, e, n.host, n.ssl, n.experimentalForceLongPolling, n.experimentalAutoDetectLongPolling);
    }(t.I_, t.w_, e);
    t.Lf = new Na$1(t.m_, t.Mf, n);
}
    ...
    return t.fs.enqueue((function() {
        return __awaiter(r, void 0, void 0, (function() {
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return o.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , Aa$1(t, n) ];

                  case 1:
                    return o.sent(), [ 4 /*yield*/ , Sa$1(t, e) ];
 ...
 */
function Ga$1(t) {
    if (t.R_ || t.P_) throw new U$1(V$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ var Ba$1 = /** @class */ function() {
    ...
    return t.prototype.$f = function(t, e) {
        ...
        T$1("Document " + i + " contains a document reference within a different database (" + r.projectId + "/" + r.database + ") which is not supported. It will be treated as a reference in the current database (" + e.projectId + "/" + e.database + ") instead."), 
        i;
    }, t;
}(), Ka$1 = /** @class */ function() {
    ...
    t.prototype.data = function() {
        if (this.Jf) {
            if (this.v_) {
                ...
                var t = new Ha$1(this.zf, this.Hf, this.S_, this.Jf, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this.Jf) {
            var e = this.Jf.data().field(Ja$1("DocumentSnapshot.get", t));
            if (null !== e) return this.Hf.$f(e);
        }
    }, t;
}(), Ha$1 = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    /**
 ...
 */
function Ja$1(t, e) {
    return "string" == typeof e ? ba$1(t, e) : e instanceof q$1 ? e._.d_ : e.d_;
}
 ...
 * limitations under the License.
 */ function Wa$1(t) {
    if (ce(t) && 0 === t.Nt.length) throw new U$1(V$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var Xa$1 = /** @class */ function(t) {
    ...
    return __extends$1(e, t), e.prototype.Yf = function(t) {
        var e = ra$1(t.firestore), n = function(t, e, n, r, i, o, u) {
            var s;
            if (i.ht()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || ic$1(u, o), 
            s = pa$1(n, "where", u, 
            ...
            return function(t, e) {
                if (e.xt()) {
                    var n = he(t);
                    if (null !== n && !n.isEqual(e.field)) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = fe(t);
                    null !== r && oc$1(t, e.field, r);
                }
                var i = function(t, e) {
                    for (var n = 0, r = t.filters; n < r.length; n++) {
                        var i = r[n];
 ...
 */
                ...
                throw i === e.op ? new U$1(V$1.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new U$1(V$1.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, l), l;
    ...
    return __extends$1(e, t), e.prototype.Yf = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new ee(e, n);
            return function(t, e) {
                if (null === fe(t)) {
                    // This is the first order by. It must match any inequality.
                    var n = he(t);
                    null !== n && oc$1(t, n, e.field);
                }
            }(t, r), r;
...
function nc$1(t, e, n, r) {
    if (n[0] instanceof q$1 && (n[0] = n[0]._), n[0] instanceof Ka$1) return function(t, e, n, r, i) {
        if (!r) throw new U$1(V$1.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        for (var o = [], u = 0, s = pe(t); u < s.length; u++) {
            ...
            if (a.field.ht()) o.push(At(e, r.key)); else {
                ...
                if (pt(c)) throw new U$1(V$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var f = a.field.ot();
                    throw new U$1(V$1.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + f + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    var i = ra$1(t.firestore);
    return function(t, e, n, r, i, o) {
        // Use explicit order by's because it has to match the query the user made
        var u = t.Nt;
        if (i.length > u.length) throw new U$1(V$1.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var s = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (u[a].field.ht()) {
                if ("string" != typeof c) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!le(t) && -1 !== c.indexOf("/")) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var f = t.path.child(et.ct(c));
                if (!it.Et(f)) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + f + "' is not because it contains an odd number of segments.");
                var h = new it(f);
                s.push(At(e, h));
            } else {
                var l = pa$1(n, r, c);
...
function rc$1(t, e, n) {
    if (n instanceof q$1 && (n = n._), "string" == typeof n) {
        if ("" === n) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!le(e) && -1 !== n.indexOf("/")) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(et.ct(n));
        if (!it.Et(r)) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return At(t, new it(r));
    }
    if (n instanceof Gs) return At(t, n.S_);
    throw new U$1(V$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Us(n) + ".");
}
 ...
 * array requirements.
 */ function ic$1(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function oc$1(t, e, n) {
    if (!n.isEqual(e)) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
...
var ac$1 = /** @class */ function(t) {
    ...
    e.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this.Jf) {
            if (this.v_) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new hc$1(this.zf, this.Hf, this.S_, this.Jf, this.metadata, 
                /* converter= */ null);
    ...
    e.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this.Jf) {
            var n = this.Jf.data().field(Ja$1("DocumentSnapshot.get", t));
            if (null !== n) return this.Hf.$f(n, e.serverTimestamps);
        }
    }, e;
}(Ka$1), hc$1 = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    /**
...
}(fc$1), lc$1 = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this.zf = t, this.Hf = e, this.ud = r, this.metadata = new cc$1(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this.ud.docs.forEach((function(r) {
            t.call(e, new hc$1(n.zf, n.Hf, r.key, r, new cc$1(n.ud.Ce.has(r.key), n.ud.fromCache), n.query.v_));
        }));
    }, 
    /**
    ...
    t.prototype.docChanges = function(t) {
        ...
        if (e && this.ud.Ne) throw new U$1(V$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t.ud.De.nt()) {
                ...
                return t.ud.docChanges.map((function(e) {
                    var r = new hc$1(t.zf, t.Hf, e.doc.key, e.doc, new cc$1(t.ud.Ce.has(e.doc.key), t.ud.fromCache), t.query.v_);
                    return e.doc, {
                        type: "added",
                        doc: r,
                        oldIndex: -1,
            ...
            return t.ud.docChanges.filter((function(t) {
                ...
                var n = new hc$1(t.zf, t.Hf, e.doc.key, e.doc, new cc$1(t.ud.Ce.has(e.doc.key), t.ud.fromCache), t.query.v_), i = -1, o = -1;
 ...
 */ function dc$1(t, e) {
    return t instanceof fc$1 && e instanceof fc$1 ? t.zf === e.zf && t.S_.isEqual(e.S_) && (null === t.Jf ? null === e.Jf : t.Jf.isEqual(e.Jf)) && t.v_ === e.v_ : t instanceof lc$1 && e instanceof lc$1 && t.zf === e.zf && Qs(t.query, e.query) && t.metadata.isEqual(e.metadata) && t.ud.isEqual(e.ud);
}
 ...
 */ function yc$1(t, e, n) {
    ...
    t = Ms(t, Gs);
    var o = Ms(t.firestore, qa$1), u = ra$1(o);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    return e instanceof q$1 && (e = e._), gc$1(o, [ ("string" == typeof e || e instanceof ks ? la(u, "updateDoc", t.S_, e, n, r) : ha$1(u, "updateDoc", t.S_, e)).O_(t.S_, je.exists(!0)) ]);
}
 ...
 */ function mc$1(t) {
    ...
    t instanceof q$1 && (t = t._);
    var u = {
        includeMetadataChanges: !1
    }, s = 0;
    "object" != typeof i[s] || uc$1(i[s]) || (u = i[s], s++);
    var a, c, f, h = {
    ...
    if (t instanceof Gs) c = Ms(t.firestore, qa$1), f = se(t.S_.path), a = {
        next: function(e) {
            i[s] && i[s](wc$1(c, t, e));
        },
        error: i[s + 1],
        ...
        var p = Ms(t, Bs);
        c = Ms(p.firestore, qa$1), f = p.C_;
        var d = new vc$1(c);
        a = {
            next: function(t) {
                i[s] && i[s](new lc$1(c, d, p, t));
            },
            error: i[s + 1],
            complete: i[s + 2]
        }, Wa$1(t.C_);
...
/** Locally writes `mutations` on the async queue. */ function gc$1(t, e) {
    return function(t, e) {
        var n = this, r = new vr;
        return t.fs.ys((function() {
 ...
 */ function wc$1(t, e, n) {
    var r = n.docs.get(e.S_), i = new vc$1(t);
    return new fc$1(t, i, e.S_, r, new cc$1(n.hasPendingWrites, n.fromCache), e.v_);
}
 ...
 */ var bc$1 = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this.zf = t, this._d = e, this.fd = [], this.dd = !1, this.wd = ra$1(t);
    }
    return t.prototype.set = function(t, e, n) {
        this.Ed();
        var r = _c(t, this.zf), i = sc$1(r.v_, e, n), o = ia(this.wd, "WriteBatch.set", r.S_, i, null !== r.v_, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return e instanceof q$1 && (e = e._), o = "string" == typeof e || e instanceof ks ? la(this.wd, "WriteBatch.update", u.S_, e, n, r) : ha$1(this.wd, "WriteBatch.update", u.S_, e), 
    ...
    t.prototype.commit = function() {
        ...
        if (this.dd) throw new U$1(V$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();

function _c(t, e) {
    if (t instanceof q$1 && (t = t._), t.firestore !== e) throw new U$1(V$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ var Ic$1 = /** @class */ function(t) {
     ...
     */    return __extends$1(e, t), e.prototype.get = function(e) {
        var n = this, r = _c(e, this.zf), i = new vc$1(this.zf);
        return t.prototype.get.call(this, e).then((function(t) {
            return new fc$1(n.zf, i, r.S_, t.Jf, new cc$1(
            /* hasPendingWrites= */ !1, 
            /* fromCache= */ !1), r.v_);
        }));
    }, e;
    ...
    /** @hideconstructor */
    function t(t, e) {
        this.zf = t, this.Td = e, this.wd = ra$1(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = _c(t, this.zf), r = new ac$1(this.zf);
        return this.Td.ef([ n.S_ ]).then((function(t) {
            if (!t || 1 !== t.length) return S$1();
            var i = t[0];
            if (i instanceof Ut) return new Ka$1(e.zf, r, n.S_, null, n.v_);
            if (i instanceof Vt) return new Ka$1(e.zf, r, i.key, i, n.v_);
            throw S$1();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = _c(t, this.zf), i = sc$1(r.v_, e, n), o = ia(this.wd, "Transaction.set", r.S_, i, null !== r.v_, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return e instanceof q$1 && (e = e._), o = "string" == typeof e || e instanceof ks ? la(this.wd, "Transaction.update", u.S_, e, n, r) : ha$1(this.wd, "Transaction.update", u.S_, e), 
    ...
    return t.prototype.enableIndexedDbPersistence = function(t, e) {
        return function(t, e) {
            Ga$1(t = Ms(t, qa$1));
            var n = ja$1(t), r = t.p_(), i = new As;
            return za$1(n, i, new Ts(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
        }(t._, {
            forceOwnership: e
        });
        ...
        return function(t) {
            Ga$1(t = Ms(t, qa$1));
            var e = ja$1(t), n = t.p_(), r = new As;
            return za$1(e, r, new Ns(r, n.cacheSizeBytes));
        }(t._);
    }, t.prototype.clearIndexedDbPersistence = function(t) {
        return function(t) {
            var e = this;
            if (t.R_ && !t.P_) throw new U$1(V$1.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
            var n = new vr;
 ...
 */;
    ...
    return __extends$1(e, t), Object.defineProperty(e.prototype, "I_", {
        ...
        !function(t, e, n) {
            var r = (t = Ms(t, zs)).V_();
            "firestore.googleapis.com" !== r.host && r.host !== e && N$1("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
            ...
            return t.fs.enqueue((function() {
                return __awaiter(e, void 0, void 0, (function() {
                    ...
                    return __generator(this, (function(r) {
                        switch (r.label) {
                          case 0:
                            return [ 4 /*yield*/ , ka$1(t) ];

                          case 1:
                            return e = r.sent(), [ 4 /*yield*/ , Pa$1(t) ];
        ...
        /** Disables the network connection. Pending operations will not complete. */ (ja$1(Ms(this._, qa$1)));
                            ...
                            return n = r.sent(), [ 2 /*return*/ , (e.Vo(!1), function(t) {
                                return __awaiter(this, void 0, void 0, (function() {
                                    ...
                                    return __generator(this, (function(n) {
                                        switch (n.label) {
                                          case 0:
                                            return (e = x$1(t)).Oh.add(0 /* UserDisabled */), [ 4 /*yield*/ , ru(e) ];
 ...
 */;
            }(ja$1(t = Ms(t, qa$1)), uc$1(e) ? e : {
                next: e
            });
        }(this._, t);
    }, Object.defineProperty(e.prototype, "app", {
        get: function() {
            if (!this.md) throw new U$1(V$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.md;
        },
        enumerable: !1,
        configurable: !0
        ...
        try {
            return new Mc$1(this, Hs(this._, t));
        } catch (t) {
            throw kc$1(t, "collection()", "Firestore.collection()");
        }
    }, e.prototype.doc = function(t) {
        try {
            return new xc(this, Js(this._, t));
        } catch (t) {
            throw kc$1(t, "doc()", "Firestore.doc()");
        }
    }, e.prototype.collectionGroup = function(t) {
        try {
            return new Rc$1(this, function(t, e) {
                if (t = Ms(t, zs), Ps("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new Bs(t, 
                /* converter= */ null, 
                /**
 ...
 */
            ...
            throw kc$1(t, "collectionGroup()", "Firestore.collectionGroup()");
        }
                    ...
                    return __awaiter(n, void 0, void 0, (function() {
                        ...
                        return __generator(this, (function(i) {
                            switch (i.label) {
                              ...
                              case 1:
                                return n = i.sent(), new Ta$1(t.fs, n, e, r).run(), [ 2 /*return*/ ];
                            }
                        }));
                    }));
                })), r.promise;
            }(ja$1(t), (function(n) {
                return e(new Ic$1(t, n));
            }));
        }(this._, (function(n) {
        ...
        var t = this;
        return ja$1(this._), new Dc$1(new bc$1(this._, (function(e) {
            return gc$1(t._, e);
        })));
    }, e.prototype.loadBundle = function(t) {
        throw new U$1(V$1.FAILED_PRECONDITION, '"loadBundle()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, e.prototype.namedQuery = function(t) {
        throw new U$1(V$1.FAILED_PRECONDITION, '"namedQuery()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, e;
}(q$1), Nc$1 = /** @class */ function(t) {
    function e(e) {
        var n = this;
        return (n = t.call(this) || this).firestore = e, n;
    }
    return __extends$1(e, t), e.prototype.Uf = function(t) {
        return new z$1(new M$1(t));
    }, e.prototype.Qf = function(t) {
        var e = this.Gf(t, this.firestore.I_);
 ...
 */ var Sc$1 = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, n) || this).zf = e, r.Hf = new Nc$1(e), r;
    }
    return __extends$1(e, t), e.prototype.get = function(t) {
        var e = this, n = qc$1(t);
        return this._.get(n).then((function(t) {
            return new Lc$1(e.zf, new fc$1(e.zf._, e.Hf, t.S_, t.Jf, t.metadata, n.v_));
        }));
        ...
        var u = qc$1(t);
        return 2 === arguments.length ? this._.update(u, e) : (r = this._).update.apply(r, __spreadArrays([ u, e, n ], i)), 
        this;
    }, e.prototype.delete = function(t) {
        var e = qc$1(t);
        return this._.delete(e), this;
    }, e;
}(q$1), Dc$1 = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
...
}(q$1), xc = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, n) || this).firestore = e, r.Hf = new Nc$1(e), r;
    }
    return __extends$1(e, t), e.Rd = function(t, n, r) {
        if (t.length % 2 != 0) throw new U$1(V$1.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.ot() + " has " + t.length);
        ...
        get: function() {
            return new Mc$1(this.firestore, this._.parent);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(e.prototype, "path", {
        ...
        try {
            return new Mc$1(this.firestore, Hs(this._, t));
        } catch (t) {
            throw kc$1(t, "collection()", "DocumentReference.collection()");
        }
    }, e.prototype.isEqual = function(t) {
        return t instanceof q$1 && (t = t._), t instanceof Gs && Ws(this._, t);
    }, e.prototype.set = function(t, e) {
        e = Ls("DocumentReference.set", e);
        try {
            return function(t, e, n) {
                t = Ms(t, Gs);
                var r = Ms(t.firestore, qa$1), i = sc$1(t.v_, e, n);
                return gc$1(r, [ ia(ra$1(r), "setDoc", t.S_, i, null !== t.v_, n).O_(t.S_, je.jt()) ]);
            }(this._, t, e);
        } catch (t) {
            throw kc$1(t, "setDoc()", "DocumentReference.set()");
        }
    }, e.prototype.update = function(t, e) {
        for (var n = [], r = 2; r < arguments.length; r++) n[r - 2] = arguments[r];
        try {
            return 1 === arguments.length ? yc$1(this._, t) : yc$1.apply(void 0, __spreadArrays([ this._, t, e ], n));
        } catch (t) {
            throw kc$1(t, "updateDoc()", "DocumentReference.update()");
        }
    }, e.prototype.delete = function() {
        return gc$1(Ms((t = this._).firestore, qa$1), [ new nn(t.S_, je.jt()) ]);
        var t;
        /**
 ...
 */    }, e.prototype.onSnapshot = function() {
        ...
        var r = Oc$1(e), i = Pc$1(e, (function(e) {
            return new Lc$1(t.firestore, new fc$1(t.firestore._, t.Hf, e.S_, e.Jf, e.metadata, t._.v_));
        }));
        return mc$1(this._, r, i);
    }, e.prototype.get = function(t) {
        var e = this;
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            t = Ms(t, Gs);
            var e = Ms(t.firestore, qa$1), n = ja$1(e), r = new vc$1(e);
            return function(t, e) {
                var n = this, r = new vr;
                return t.fs.ys((function() {
                    return __awaiter(n, void 0, void 0, (function() {
                                    ...
                                    return __awaiter(this, void 0, void 0, (function() {
                                        ...
                                        return __generator(this, (function(o) {
                                            switch (o.label) {
                                              ...
                                              case 1:
                                                return (i = o.sent()) instanceof Vt ? n.resolve(i) : i instanceof Ut ? n.resolve(null) : n.reject(new U$1(V$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                [ 3 /*break*/ , 3 ];
                ...
                return new fc$1(e, r, t.S_, n, new cc$1(n instanceof Vt && n.bt, 
                /* fromCache= */ !0), t.v_);
            }));
        }(this._) : "server" === (null == t ? void 0 : t.source) ? function(t) {
            t = Ms(t, Gs);
            var e = Ms(t.firestore, qa$1);
            return Ra$1(ja$1(e), t.S_, {
                source: "server"
            }).then((function(n) {
                return wc$1(e, t, n);
            }));
            ...
            t = Ms(t, Gs);
            var e = Ms(t.firestore, qa$1);
            return Ra$1(ja$1(e), t.S_).then((function(n) {
                return wc$1(e, t, n);
            }));
        }(this._)).then((function(t) {
            return new Lc$1(e.firestore, new fc$1(e.firestore._, e.Hf, t.S_, t.Jf, t.metadata, e._.v_));
        }));
    }, e.prototype.withConverter = function(t) {
...
function Oc$1(t) {
    for (var e = 0, n = t; e < n.length; e++) {
        var r = n[e];
        if ("object" == typeof r && !uc$1(r)) return r;
    }
    return {};
}
 ...
 */ function Pc$1(t, e) {
    ...
    return {
        ...
        error: null === (n = (i = uc$1(t[0]) ? t[0] : uc$1(t[1]) ? t[1] : "function" == typeof t[0] ? {
            next: t[0],
            error: t[1],
            complete: t[2]
        } : {
...
var Lc$1 = /** @class */ function(t) {
    ...
    return __extends$1(e, t), Object.defineProperty(e.prototype, "ref", {
        ...
        return dc$1(this._, t._);
    }, e;
}(q$1), Cc$1 = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    ...
    return __extends$1(e, t), e.prototype.where = function(t, n, r) {
        try {
            ...
            return new e(this.firestore, Ya$1(this._, function(t, e, n) {
                var r = e, i = Ja$1("where", t);
                return new Xa$1(i, r, n);
            }(t, n, r)));
        } catch (t) {
            throw kc$1(t, /(orderBy|where)\(\)/, "Query.$1()");
        }
        ...
        try {
            ...
            // FieldPath Compat type as input, but is not typed as such in order to
            // not expose this via our public typings file.
            return new e(this.firestore, Ya$1(this._, function(t, e) {
                void 0 === e && (e = "asc");
                var n = e, r = Ja$1("orderBy", t);
                return new $a$1(r, n);
            }(t, n)));
        } catch (t) {
            throw kc$1(t, /(orderBy|where)\(\)/, "Query.$1()");
        ...
        try {
            return new e(this.firestore, Ya$1(this._, function(t) {
                return qs("limit", t), new Za$1("limit", t, "F" /* First */);
            }(t)));
        } catch (t) {
            throw kc$1(t, "limit()", "Query.limit()");
        }
    }, e.prototype.limitToLast = function(t) {
        try {
            return new e(this.firestore, Ya$1(this._, function(t) {
                return qs("limitToLast", t), new Za$1("limitToLast", t, "L" /* Last */);
            }(t)));
        } catch (t) {
            throw kc$1(t, "limitToLast()", "Query.limitToLast()");
        }
    }, e.prototype.startAt = function() {
        for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
        try {
            return new e(this.firestore, Ya$1(this._, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new tc("startAt", t, /*before=*/ !0);
            }.apply(void 0, t)));
        } catch (t) {
            throw kc$1(t, "startAt()", "Query.startAt()");
        }
        ...
        try {
            ...
            throw kc$1(t, "startAfter()", "Query.startAfter()");
        }
        ...
        try {
            return new e(this.firestore, Ya$1(this._, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new ec$1("endBefore", t, /*before=*/ !0);
            }.apply(void 0, t)));
        } catch (t) {
            throw kc$1(t, "endBefore()", "Query.endBefore()");
        }
        ...
        try {
            return new e(this.firestore, Ya$1(this._, function() {
                for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
                return new ec$1("endAt", t, /*before=*/ !1);
            }.apply(void 0, t)));
        } catch (t) {
            throw kc$1(t, "endAt()", "Query.endAt()");
        }
    }, e.prototype.isEqual = function(t) {
     ...
     */
        function(t) {
            ...
            t = Ms(t, Bs);
            var e = Ms(t.firestore, qa$1), n = ja$1(e), r = new vc$1(e);
            return Wa$1(t.C_), Va$1(n, t.C_).then((function(n) {
                return new lc$1(e, r, t, n);
            }));
        }(this._)).then((function(t) {
            return new Uc$1(e.firestore, new lc$1(e.firestore._, e.Hf, e._, t.ud));
        }));
    }, e.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = Oc$1(e), i = Pc$1(e, (function(e) {
            return new Uc$1(t.firestore, new lc$1(t.firestore._, t.Hf, t._, e.ud));
        }));
        return mc$1(this._, r, i);
    }, e.prototype.withConverter = function(t) {
        return new e(this.firestore, this._.withConverter(t));
    }, e;
}(q$1), Vc$1 = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
        return (r = t.call(this, n) || this).zf = e, r;
    }
    return __extends$1(e, t), Object.defineProperty(e.prototype, "type", {
        ...
        get: function() {
            return new Cc$1(this.zf, this._.doc);
        },
        enumerable: !1,
        configurable: !0
    ...
    return __extends$1(e, t), Object.defineProperty(e.prototype, "query", {
        get: function() {
            return new Rc$1(this.zf, this._.query);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(e.prototype, "metadata", {
        ...
        return this._.docChanges(t).map((function(t) {
            return new Vc$1(e.zf, t);
        }));
    }, e.prototype.forEach = function(t, e) {
        var n = this;
        this._.forEach((function(r) {
            t.call(e, new Cc$1(n.zf, r));
        }));
    }, e.prototype.isEqual = function(t) {
        return dc$1(this._, t._);
    }, e;
}(q$1), Mc$1 = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
    ...
    return __extends$1(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        try {
            ...
            throw kc$1(t, "doc()", "CollectionReference.doc()");
        }
    }, e.prototype.add = function(t) {
        var e = this;
        return function(t, e) {
            var n = Ms(t.firestore, qa$1), r = Js(t), i = sc$1(t.v_, e);
            return gc$1(n, [ ia(ra$1(t.firestore), "addDoc", r.S_, i, null !== t.v_, {}).O_(r.S_, je.exists(!1)) ]).then((function() {
                return r;
            }));
...
function qc$1(t) {
    return t instanceof q$1 && (t = t._), Ms(t, Gs);
}
 ...
 */ var jc$1 = /** @class */ function(t) {
    ...
    function e() {
        ...
        return t.call(this, new (ks.bind.apply(ks, __spreadArrays([ void 0 ], e)))) || this;
    }
    return __extends$1(e, t), e.documentId = function() {
        ...
        return t instanceof q$1 && (t = t._), t instanceof ks && this._.d_.isEqual(t.d_);
    }, e;
}(q$1), Fc$1 = /** @class */ function(t) {
    function e() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return __extends$1(e, t), e.serverTimestamp = function() {
        var t = new sa$1("serverTimestamp");
        return t._methodName = "FieldValue.serverTimestamp", new e(t);
    }, e.delete = function() {
        var t = new oa$1("deleteField");
...
var I$2 = {
    ...
    Query: Rc$1,
    QueryDocumentSnapshot: Cc$1,
    QuerySnapshot: Uc$1,
    CollectionReference: Mc$1,
    FieldPath: jc$1,
    FieldValue: Fc$1,
    setLogLevel: Ac$1,
    CACHE_SIZE_UNLIMITED: Ma$1
};
 ...
 */
    function(e, r) {
        ...
        return new Tc$1(e, new qa$1(e, i), new Ec$1);
